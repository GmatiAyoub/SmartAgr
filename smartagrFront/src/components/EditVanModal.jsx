...
// props : van objet contenant les infos du van a modifier 
// onClose fonction pour fermer la modal
// onSave fonction pour enregistrer les modifications du van
function EditVanModal({ van, onClose, onSave }) {
    ...
    }, [van]); // S'exécute à chaque fois que VAN change
